...
const knownLogos = new Set([
  'a-team', 'ais', 'ararabots', 'blue', 'carrossel-caipira', 'cerberus', 'cmμs',
  'delft-mercurians', 'eagles', 'er-force', 'greentea', 'ibis', 'immortals',
  'itandroids', 'kiks', 'luhbots', 'maracatronics', 'mct-susano-logics', 'mrl',
